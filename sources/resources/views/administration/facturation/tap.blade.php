    ...
    <div class="row margin-top-20">
        ...
        <div class="col-md-10 col-md-offset-1 margin-top-10">
            ...
            <table class="table table-striped margin-top-15">
                <thead>
                     <tr><th>Nom</th><th>Prenom</th><th>Hingois</th><th>L1</th><th>Ma2</th><th>Me3</th><th>J4</th><th>V5</th></tr>
                </thead>
                <tr>
                    <td>Jean</td><td>Paul</td><td>{!! Form::checkbox("",null,null); !!}</td><td>X</td><td>X</td><td>X</td><td>X</td><td>X</td>
                </tr>
                <tr>
                    <td>Jean</td><td>Jacques</td><td>{!! Form::checkbox("",null,null); !!}</td><td>X</td><td>X</td><td>X</td><td>X</td><td>X</td>
                </tr>
            </table>
