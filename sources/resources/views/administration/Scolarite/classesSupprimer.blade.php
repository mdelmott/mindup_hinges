    ...
    <div class="row margin-top-50">
        ...
        <div class="col-md-6 col-sm-7 col-md-offset-1">
            {!! Form::model(['class' => 'form-inline', 'url' => 'foo/bar']) !!}
                ...
                <div class="col-md-5 col-sm-6 col-md-offset-1">{!! Form::submit('Supprimer la classe', ['action' =>'SupprimerClasse','class' => 'btn btn-primary form-control'])!!}</div>
                <div class="col-md-5 col-sm-5 col-md-offset-1">{!! Form::submit('Enregistrer', ['action' =>'EnregistrerClasse','class' => 'btn btn-primary form-control'])!!}</div>
            {!! Form::close() !!}
        </div>
